...
CLIENT_SECRETS_FILEPATH = os.path.join(CLIENT_SECRETS_DIRECTORY, CLIENT_SECRETS_FILE)
...
""" % os.path.abspath(os.path.join(os.path.dirname(__file__), CLIENT_SECRETS_FILEPATH))
